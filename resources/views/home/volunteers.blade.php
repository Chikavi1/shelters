...
<section class="px-4  mx-auto max-w-7xl">
    ...
    <div class="grid items-center grid-cols-1 mb-24 md:grid-cols-2 gap-y-10 md:gap-y-32 gap-x-10 md:gap-x-24">
      ...
      <div class="w-full h-full py-48">
        <img class="rounded-lg" src="https://i.ibb.co/ZMMkTSP/Brown-Minimalist-Mindmap-Circle-Connect-Diagram-Graph.png" alt="">
      </div>
    </div>
    <div class="grid flex-col-reverse items-center grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-y-32 gap-x-10 md:gap-x-24">
      <div class="order-none md:order-2">
        ...
        <a href="/benefits" class="w-full btn btn-dark btn-lg sm:w-auto font-bold text-purple-800">Mirar beneficios</a>
      </div>
      ...
      <div class="flex flex-col justify-center">
        <div class="max-w-xl mb-6">
          ...
          <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
            Tienes la capacidad de ayudar a reducir los costos hasta en 50,000 MXN  <span class="text-sm">( 2,700 dlls aprox)</span>
          </h2>
          <p class="text-base text-gray-700 md:text-lg">
            Al ser casa puente tienes  la capacidad de ayudar a una organización a reducir sus costos hasta en 50,000 pesos por cada mascota       </p>
        </div>
  ...
  <section class="w-full bg-gradient-to-b from-gray-100 to-white">
    <div class="w-full px-4 py-20 mx-auto text-left md:text-center md:w-3/4 lg:w-2/4">
      <p class="mb-2 text-base  text-purple-500">Se parte del cambio</p>
      ...
      <div class="mb-0 space-x-0 md:space-x-2">
        <a class="inline-flex text-xl text-purple-800 font-bold items-center justify-center w-full mb-2 btn btn-primary btn-lg sm:w-auto sm:mb-0" href="/register-users">
