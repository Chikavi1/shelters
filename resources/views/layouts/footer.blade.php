<footer class="px-4 py-12 mx-auto max-w-7xl">
    <div class="grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20">
      <div class="col-span-3">
        <a href="https://www.radi.pet/" title="Go to Kutty Home Page">
          ...
          <h2 class="font-semibold">Radi Pets</h2>
          {{-- <span class="sr-only">Radi Pets</span> --}}
        </a>
        <p class="my-4 text-xs leading-normal text-gray-500">
            Trabajemos juntos para generar un cambio positivo en las mascotas.
        </p>
      ...
      <nav class="col-span-1 md:col-span-1 lg:col-span-3">
        <p class="mb-3 text-xs font-semibold tracking-wider text-gray-400 uppercase">Servicios</p>
        <a href="/org" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Organizaciones</a>
        <a href="/bridge" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Casas Puentes</a>
        <a href="#" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Negocios</a>
      ...
      <nav class="col-span-1 md:col-span-1 lg:col-span-3">
        <p class="mb-3 text-xs font-semibold tracking-wider text-gray-400 uppercase">Acerca</p>
        <a href="/benefits" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Beneficios</a>
        <a href="#" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Registrate como Casa</a>
        <a href="#" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Registrate como Organización</a>
        <a href="#" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Registrate como Negocio</a>
      </nav>
      <nav class="col-span-2 md:col-span-1 lg:col-span-3">
        <p class="mb-3 text-xs font-semibold tracking-wider text-gray-400 uppercase">Contacto</p>
        <a href="#" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Instagram</a>
        <a href="#" class="flex mb-3 text-sm font-medium text-gray-800 transition md:mb-2 hover:text-primary">Facebook</a>
    ...
    <div class="flex flex-col items-start justify-between pt-10 mt-10 border-t border-gray-100 md:flex-row md:items-center">
      <p class="mb-6 text-sm text-left text-gray-600 md:mb-0">© Copyright 2023 Radi Pets.</p>
      <div class="flex items-start justify-start space-x-6 md:items-center md:justify-center">
        <a href="#" class="text-sm text-gray-600 transition hover:text-primary">Terminos</a>
        <a href="#" class="text-sm text-gray-600 transition hover:text-primary">Privacidad</a>
      </div>
    </div>
  </footer>
